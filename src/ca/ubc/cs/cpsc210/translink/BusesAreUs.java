...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public static final String TRANSLINK_API_KEY = "50PZlJVBW0g05NbQyTKH";
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        if(nearest == null){
            nearestStopLabel.setText("All Stops Out of Range");
        }
        if(nearest != null) {
            myNearestStop = nearest;
            nearestStopLabel.clearComposingText();
     ...
     */
    @Override
    public void onStopSelected(Stop stop) throws StopException {
    ...
    private class DownloadArrivalDataTask extends AsyncTask<Stop, Integer, String> {
        ...
        protected String doInBackground(Stop... stops) {
            ...
            dataProvider = new HttpArrivalDataProvider(stop);
